...
#esto de abajo tendría que comentarlo para que no salte al menu "formal"
screen main_menu():
        ...
        grid columns rows:
            ...
            for i in range(1, columns * rows + 1):
                ...
                button:
                    ...
                    $ file_time = FileTime(i, empty=_("Ranura vacía."))
    ...
    grid 3 1:
        ...
        vbox:
            ...
            frame:
                ...
                textbutton _("Ningunas") action Preference("transitions", "none")
