...
init -1 python hide:
    ...
    style.default.font = "insomniac3.ttf"
    ...
    style.button.activate_sound = "click0.wav"
    ...
    config.main_menu_music = "intro2.mp3"
...
python early:
    config.save_directory = "Elecciones Generales-1442586048"
...
init python:
    ...
    build.directory_name = "EleccionesGenerales-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "EleccionesGenerales"
